...
.errorcont h1,.errorcont ul,.errorcont ul li,.errorcont ul li span{font:14px/1.6 'Microsoft YaHei',Verdana,Arial,sans-serif}
.errorcont{width:65%;margin:150px auto 0;overflow:hidden;color:#000;border-radius:5px;box-shadow:0 0 20px #555;background:#fff;min-width:300px}
...
.errorcont ul,.errorcont h1{width:95%;margin:0 auto;overflow:hidden}
.errorcont ul{list-style:none;padding:3px;word-break:break-all}
.errorcont ul li{padding:0 3px}
